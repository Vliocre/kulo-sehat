    ...
    $utilities = [
        [
            ...
            'desc'  => 'Edit, arsipkan, atau publikasikan artikel medis Anda.',
            'cta'   => 'Buka daftar',
            'href'  => route('doctor.articles.index')
        ],
        [
            'title' => 'Buat Artikel Baru',
            'desc'  => 'Mulai dari template klinis agar penulisan lebih cepat.',
            'cta'   => 'Tulis artikel',
            'href'  => route('doctor.articles.create')
        ],
    ];

    $collabs = [
        [
            'title' => 'Kolaborasi Klinik',
            'desc'  => 'Sinkronkan informasi layanan klinik dan jadwal praktik.',
            'image' => 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=900&q=80'
        ],
        [
            'title' => 'Inisiatif Edukasi',
            'desc'  => 'Program webinar, bulletin, dan kampanye pencegahan.',
            'image' => 'https://images.unsplash.com/photo-1505751172876-fa1923c5c528?auto=format&fit=crop&w=900&q=80'
        ],
        [
            'title' => 'Pusat Komunitas',
            'desc'  => 'Tanggapi pertanyaan pasien dan kumpulkan umpan balik.',
            'image' => 'https://images.unsplash.com/photo-1582719478248-48cd1f0c1a97?auto=format&fit=crop&w=900&q=80'
        ],
    ];
@endphp
