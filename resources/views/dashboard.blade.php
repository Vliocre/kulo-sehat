...
<head>
    ...
    <style>
        ...
        .hero-glow {
            position: absolute;
            inset: 0;
            background: linear-gradient(145deg, rgba(34, 197, 94, 0.9), rgba(163, 230, 53, 0.85));
            border-radius: 40px;
             ...
             <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div class="hero-card px-6 py-10 sm:px-10 md:px-16 flex flex-col md:flex-row items-center gap-10 md:gap-12">
                    <div class="w-full md:w-1/2 text-center md:text-left">
                        <p class="text-xs sm:text-sm uppercase tracking-[0.35em] text-gray-400 font-semibold">Temukan Informasi Kesehatan Terpercaya</p>
                        <h1 class="mt-4 text-3xl sm:text-4xl md:text-5xl font-bold leading-tight text-gray-900">
                            Akses Mudah,<br>
                            <span class="text-green-600">Informasi Akurat</span><br>
                            untuk Kesehatan Optimal Anda
                        </h1>
                        <p class="mt-5 text-base text-gray-600 max-w-xl mx-auto md:mx-0">Selamat datang di KuloSehat. Kami menyediakan berbagai artikel dan panduan informatif mengenai penyakit umum, gejala, cara pencegahan, serta penanganan awal yang bisa Anda lakukan. Dapatkan pemahaman yang lebih baik tentang kesehatan Anda.</p>
                        <div class="mt-8 flex justify-center md:justify-start">
                            <a href="#artikel-terbaru" class="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-7 rounded-full shadow-lg shadow-green-500/40 transition">
                                Jelajahi Sekarang
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl">
                    <div class="p-6 md:p-10">
                        ...
                        <div class="space-y-6">
                            ...
                            @empty
                                <div class="text-center py-16"><p class="text-gray-500 text-lg">Saat ini belum ada artikel.</p></div>
                            @endforelse
                        </div>
                    </div>
                </div>
